...
9. Download [Lineage Recovery](https://lineage-downloads.mainlining.org/devices/{{ custom_recovery_codename }}). Simply download the latest recovery file, named `{{ device.recovery_partition_name }}.img`.
