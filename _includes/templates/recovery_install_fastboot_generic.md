...
2. Your device utilizes retrofitted dynamic partitions (RDAP), so you'll also need to download the latest [super_empty.img](https://lineage-downloads.mainlining.org/devices/{{ device.codename }}) file.
{%- endif %}
