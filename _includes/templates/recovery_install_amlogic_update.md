...
1. Download `aml_install_package.img` file from [here](https://lineage-downloads.mainlining.org/devices/{{ device.codename }}).
...
7. Download `super_empty.img` from [here](https://lineage-downloads.mainlining.org/devices/{{ device.codename }}).
