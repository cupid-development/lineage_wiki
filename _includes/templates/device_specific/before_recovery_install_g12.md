...
## Flashing the dtb and dtbo partitions
 ...
 1. Download dtbo file from [here](https://lineage-downloads.mainlining.org/devices/{{ device.codename }}), and dtb file from [here](https://download.ods.ninja/Android/firmware/{{ device.codename }}/dtb), Rename the dtb to dtb.img.
